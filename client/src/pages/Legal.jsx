...
const DOCS = {
  ...
  privacy: {
    ...
    body: [
      ...
      ['Storage & security', 'We use access controls, encryption in transit, hashed passwords, and least-privilege access. No system is perfectly secure; please use a strong, unique password.'],
      ['Retention', 'We keep personal data for as long as your account is active and as required for legal, security, and audit purposes, then delete or anonymise it.'],
      ['Your rights', 'Subject to applicable law (including the Saudi PDPL and comparable regimes), you may request access to, correction of, or deletion of your personal data, and may object to certain processing. Contact privacy@fundamental.app.'],
